        ...
        <ul class="nav-links">
            ...
            <?php if(isset($_SESSION['id_usuario'])): ?>
                ...
                <?php if(isset($_SESSION['es_admin']) && $_SESSION['es_admin'] == true): ?>
                    <li><a href="page-commercial.php" style="color: #fbbf24;">⚙️ CRUD Equipos</a></li>
                    <li><a href="page-residential.php" style="color: #fbbf24;">⚙️ CRUD Partidos</a></li>
                <?php endif; ?>
                <li><a href="logout.php" style="color: #f87171; font-weight: bold;">Salir (<?php echo $_SESSION['username']; ?>)</a></li>
            <?php endif; ?>
        </ul>
    </nav>
</header>
